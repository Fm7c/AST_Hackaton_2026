...
3. Keep `Data.zip` next to the project folder or select its path in the sidebar.
4. Double-click `run_windows.bat`.
5. The application opens in your default browser.

## Using the application

- **Overview**: a quick summary and preview of the selected dataset.
